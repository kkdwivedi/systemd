...
const TFilterVTable *const tfilter_vtable[_TFILTER_KIND_MAX] = {
        [TFILTER_KIND_BASIC] = &basic_tfilter_vtable,
        [TFILTER_KIND_BPF] = &bpf_tfilter_vtable,
        [TFILTER_KIND_CGROUP] = &cgroup_tfilter_vtable,
        [TFILTER_KIND_FLOW] = &flow_tfilter_vtable,
        [TFILTER_KIND_FLOWER] = &flower_tfilter_vtable,
        [TFILTER_KIND_FW] = &fw_tfilter_vtable,
        [TFILTER_KIND_MATCHALL] = &matchall_tfilter_vtable,
        [TFILTER_KIND_ROUTE] = &route_tfilter_vtable,
        [TFILTER_KIND_RSVP] = &rsvp_tfilter_vtable,
        [TFILTER_KIND_TCINDEX] = &tcindex_tfilter_vtable,
        [TFILTER_KIND_U32] = &u32_tfilter_vtable,
};
